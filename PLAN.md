...
5. data/remote/RetrofitClient.kt - instance Retrofit, base URL dinamis (diisi dari hasil scan QR)
6. data/local/ConnectionPreferences.kt - simpan base URL pakai DataStore
